...
namespace SV22T1020740.Shop
{
    ...
    public class WebUserData
    {
        ...
        {
            var claimIdentity = new ClaimsIdentity(Claims, "ShopScheme");
    ...
    public static class WebUserExtensions
    {
        ...
        public static WebUserData? GetUserData(this ClaimsPrincipal principal)
        {
            try
            {
                ...
                userData.DisplayName = principal.FindFirstValue(nameof(WebUserData.DisplayName));
                userData.Email = principal.FindFirstValue(nameof(WebUserData.Email));
                userData.Photo = principal.FindFirstValue(nameof(WebUserData.Photo));
